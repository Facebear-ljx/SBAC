import wandb
import argparse
from RL_algos.stochastic_energy import Energy
import datetime
import random


def main():
    wandb.init(project="stochastic_energy", entity="facebear")
    ...
    parser.add_argument('--lmbda_min', default=0.2, type=float)
    ...
    wandb.run.name = f"{args.alpha}_{args.lmbda_min}_{env_name}_{args.negative_samples}_{args.strong_contrastive}"
