import wandb
import argparse
from RL_algos.TEST_algos import TEST


def main():
    wandb.init(project="train_test", entity="facebear")

    # Parameters
    parser = argparse.ArgumentParser(description='Solve the Hopper-v2 with TEST')
    parser.add_argument(
    ...
    # setup mujoco environment and TEST agent
    env_name = "hopper-medium-v2"
    agent_TEST = TEST(env_name=env_name,
    ...
    agent_TEST.learn(total_time_step=1e+6)
